...
class OriginalAPIAdmin(object):
    ...
    refresh_times = (3, 5)
    list_display = ('id', 'status_code', 'method', 'protocol', 'host', 'path', 'is_handled',
                    'is_active', 'create_time', 'modify_time', 'list_display_options', )
    list_display_links = ('id',)

    search_fields = ('id', 'status_code', 'method', 'protocol', 'host', 'path', 'is_handled',
                    'is_active', 'create_time', 'modify_time',)
    list_filter = ['id', 'status_code', 'method', 'protocol', 'host', 'path', 'is_handled',
                    'is_active', 'create_time', 'modify_time',]
